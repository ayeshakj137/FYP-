...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "UPDATE recipes SET title = ?, description = ?, ingredients = ?, steps = ?, category_id = ?, image = ?, prep_time = ?, cook_time = ?, servings = ? WHERE recipe_id = ?");
    mysqli_stmt_bind_param($stmt, "ssssisiiii", $title, $description, $ingredients, $steps, $category_id, $image, $prep_time, $cook_time, $servings, $recipe_id);
